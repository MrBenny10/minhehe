...
const dessertPuzzle: Puzzle = {
  ...
  clues: [
    ...
    {
      number: 1,
      text: 'Dense chocolate square, often fudgy (7)',
      direction: 'across',
    ...
    {
      number: 2,
      text: 'Pastry dish with fruit or custard (4)',
      direction: 'across',
    ...
    {
      number: 3,
      text: 'Light whipped dessert, often chocolate (6)',
      direction: 'across',
    ...
    {
      number: 4,
      text: 'Layered English dessert with sponge, fruit, custard (6)',
      direction: 'down',
    ...
    {
      number: 5,
      text: 'Dairy topping for pie or fruit (5)',
      direction: 'down',
    ...
    {
      number: 6,
      text: 'Dessert often with crust and filling (3)',
      direction: 'down',
    ...
    {
      number: 8,
      text: 'Short for frozen dessert like sorbet (3)',
      direction: 'down',
      startRow: 2, // row 3, col 10 → 0-indexed = (2,9)
      startCol: 9,
      length: 3,
      solution: 'ICE',
    },
