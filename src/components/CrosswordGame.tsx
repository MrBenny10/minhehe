...
const samplePuzzle: Puzzle = {
  ...
  clues: [
    // Across
    { number: 1, text: 'Swedish carmaker (5)', direction: 'across', startRow: 0, startCol: 1, length: 5, solution: 'VOLVO' },
    { number: 4, text: 'Swedish pop group (4)', direction: 'across', startRow: 2, startCol: 0, length: 4, solution: 'ABBA' },
    { number: 6, text: "Part of 'smorgasbord' (7)", direction: 'across', startRow: 4, startCol: 1, length: 7, solution: 'SMORGAS' },
    { number: 8, text: 'University city in Sweden (7)', direction: 'across', startRow: 6, startCol: 1, length: 7, solution: 'UPPSALA' },

    // Down
    { number: 2, text: "Swedish ideal of 'just right' (5)", direction: 'down', startRow: 2, startCol: 3, length: 5, solution: 'LAGOM' },
    { number: 3, text: 'Prize named for Alfred (5)', direction: 'down', startRow: 1, startCol: 5, length: 5, solution: 'NOBEL' },
    { number: 5, text: 'Flat-pack furniture giant (4)', direction: 'down', startRow: 2, startCol: 5, length: 4, solution: 'IKEA' },
    { number: 7, text: 'Swedish “cheers!” (4)', direction: 'down', startRow: 4, startCol: 7, length: 4, solution: 'SKAL' },
  ],
};
